layui.use(['table', 'form', 'jquery', 'layer'], function () {
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: 'pcount', title: '销量', width: 100/*, sort: true*/}
            , {field: 'repertory', title: '库存', width: 80}
            , {field: 'pflag', title: '上下架', width: 120, sort: true, templet: '#pflagcheckbox'}
            , {field: 'cname', title: '分类', width: 80, sort: true}
            , {field: 'cost', title: '成本', width: 80, sort: true}
    ...
    form.on('submit(add)', function (data) {
        ...
        $.ajax({
            ...
            method:"post",
            data:{"cid":product.cid,"pname":product.pname,"pimage":"",
    ...
    form.on('submit(edit)', function (data) {
        ...
        $.ajax({
            ...
            method:"post",
            data:{"cid":product.cid,"pname":product.pname,"pimage":product.pimage,
                "shopprice":product.shopprice,"repertory":product.repertory,
                "cost":product.cost,"pdesc":product.pdesc,"pid":product.pid,
            "pcount":product.pcount,"pflag":product.pflag,"ishot":product.ishot},
            success:function(data){
                if(data>0){
                    $('.layui-laypage-btn').click();
                    alert("修改成功")
